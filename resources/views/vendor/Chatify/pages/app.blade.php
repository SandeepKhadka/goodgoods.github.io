        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    {{-- <a href="#" class="user-name">{{ \App\Models\User::where('id',$id)->value('full_name') }}</a> --}}
                    <a href="#" class="user-name">{{ config('chatify.name') }}</a>
                </div>
                {{-- header buttons --}}
                <nav class="m-header-right">
                    @if (auth()->user()->role == 'admin' || auth()->user()->role == 'vendor')
                        <a href="#" class="success-badge" id="create-coupon-btn" style="color: white">Create
                            Coupon</a>
                    @endif
                        ...
                        <div class="modal-content">
                            ...
                            @if (auth()->user()->role == 'admin')
                                ...
                                @elseif(auth()->user()->role == 'vendor')
                                    <form action="{{ route('private.coupon') }}" method="post" class="coupon-form"
                                        enctype="multipart/form-data">
                                        @csrf
                            @endif
                            @php
                                $products_id = \App\Models\Product::where('vendor_id', auth()->user()->id)->get('id');
                            @endphp
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input type="text" id="coupon-id" name="code" required
                            ...
                            <div class="form-group">
                                <label for="discount-price">Coupon Value:</label>
                                <div class="input-group">
                                    {{-- <span class="input-group-addon">Rs</span> --}}
                                    <input type="text" id="discount-price" name="value"
                    ...
                    <a href="{{ route(auth()->user()->role) }}"><i class="fas fa-home"></i></a>
