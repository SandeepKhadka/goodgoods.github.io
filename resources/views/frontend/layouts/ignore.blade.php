...
<head>
    ...
    <title>GoodGoods - Online Shopping for Electronics, Apparel, Computers, Books, DVDs & more</title>
    <!-- Standard Favicon -->
...
<body>
    ...
    <div id="app">
                    ...
                    <div class="row clearfix align-items-center">
                        <div class="col-lg-3 col-md-9 col-sm-6">
                            <div class="brand-logo text-lg-center">
                                <a href="home.html">
                                    <img src={{ asset('frontend/images/main-logo/goodgoods-branding-1.png') }}
                                        alt="GoodGoods" class="app-brand-logo">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                                                ...
                                                <div class="v-drop-right" style="width: 700px;">
                                                    ...
                                                    <div class="v-image" style="bottom: 0;right: -25px">
                                                        <a href="#" class="d-block">
                                                            <img src={{ asset('frontend/images/banners/mega-3.png') }}
                        ...
                        <div class="col-lg-9">
                            <ul class="bottom-nav g-nav u-d-none-lg">
                                ...
                                <li>
                                    <a href="custom-deal-page.html">Offers
                                        <span class="superscript-label-discount">-10%</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="custom-deal-page.html">For You
                                    </a>
                                </li>
                                {{-- <li>
            ...
            <div class="container">
                <div class="image-banner">
                    <a href="shop-v1-root-category.html" class="mx-auto banner-hover effect-dark-opacity">
                        <img class="img-fluid" src={{ asset('frontend/images/banners/bannerlayer-1.jpg') }}
                        ...
                        <div class="item">
                            <div class="image-container">
                                <a class="item-img-wrapper-link" href="single-product.html">
                                    <img class="img-fluid" src={{ asset('frontend/images/product/product@3x.jpg') }}
                                        alt="Product">
                                </a>
                            ...
                            <div class="item-content">
                                <div class="what-product-is">
                                    <ul class="bread-crumb">
                                        <li>
                                            <a href="shop-v3-sub-sub-category.html">Product Name</a>
                                        </li>
                                    </ul>
                                    <h6 class="item-title">

                                        <a href="single-product.html">Product Description
                                        </a>
                                    </h6>
                                    <div class="item-stars">
                                        <div class='star' title="0 out of 5 - based on 0 Reviews">
        ...
        <section class="section-maker">
            <div class="container">
                <div class="sec-maker-header text-center">
                    <h3 class="sec-maker-h3">CATEGORIES</h3>
                    {{-- <ul class="nav tab-nav-style-1-a justify-content-center">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#men-latest-products">Latest
                                Products</a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <div class="products-slider owl-carousel" data-item="4">
                                        <div class="item">
                                            <div class="image-container">
                                                <a class="item-img-wrapper-link" href="single-product.html">
                                                    <img class="img-fluid"
                                                        src={{ asset('frontend/images/product/product@3x.jpg') }}
                                                        alt="Product">
                                                </a>
                                                <div class="item-action-behaviors">
        ...
        <div class="banner-image-view-more">
            <div class="container">
                {{-- <div class="image-banner u-s-m-y-40">
                    <a href="shop-v1-root-category.html" class="mx-auto banner-hover effect-dark-opacity">
                        <img class="img-fluid" src={{ asset('frontend/images/banners/ban-men.jpg') }}
                            alt="Banner Image">
                    </a>
                </div> --}}
            ...
            <div class="container">
                <div class="sec-maker-header text-center">
                    ...
                    {{-- <ul class="nav tab-nav-style-1-a justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#women-best-selling-products">Best
                                Selling</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#women-featured-products">Featured
                                Products</a>
                        </li>
                    </ul> --}}
                </div>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="item-content">
                                                <div class="what-product-is">
                                                    ...
                                                    <h6 class="item-title">
                                                        {{-- <a href="single-product.html">White Solitude Dress with mid
                                                            heel & Bag
                                                        </a> --}}
                                                        <a href="single-product.html">Product Description
                                                        </a>
                                        ...
                                        <div class="item">
                                            ...
                                            {{-- <div class="item-content">
                                                <div class="what-product-is">
                                                    ...
                                                    <h6 class="item-title">
                                                        <a href="single-product.html">Black & White Wrap Dress with
                                                            High Jewelery Necklace</a>
                                                    </h6>
                                                    <div class="item-stars">
                                                        <div class='star' title="0 out of 5 - based on 0 Reviews">
                                                            <span style='width:0'></span>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="item-content">
                                                <div class="what-product-is">
                                                    ...
                                                    <h6 class="item-title">
                                                        <a href="single-product.html">Wax Flower with Corn Silk
                                                            Heel</a>
                                                    </h6>
                                                    <div class="item-stars">
                                                        <div class='star'
            ...
            <div class="container">
                <div class="sec-maker-header text-center">
                    ...
                    <ul class="nav tab-nav-style-1-a justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#toys-best-selling-products">Best
                                Selling</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#toys-featured-products">Featured
                                Products</a>
                        </li>
                    </ul>
                </div>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="item-content">
                                                <div class="what-product-is">
                                                    ...
                                                    <h6 class="item-title">
                                                        <a href="single-product.html">DJI Phantom with 1080p
                                                            Camera</a>
                                                    </h6>
                                                    <div class="item-stars">
                                                        <div class='star' title="0 out of 5 - based on 0 Reviews">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="item-content">
                                                <div class="what-product-is">
                                                    ...
                                                    <h6 class="item-title">
                                                        <a href="single-product.html">DJI Inspire with 1080p
                                                            Camera</a>
                                                    </h6>
                                                    <div class="item-stars">
                                                        <div class='star' title="0 out of 5 - based on 0 Reviews">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="item-content">
                                                <div class="what-product-is">
                                                    ...
                                                    <h6 class="item-title">
                                                        <a href="single-product.html">DJI Inspire 1 with 360°
                                                            Camera</a>
                                                    </h6>
                                                    <div class="item-stars">
                                                        <div class='star'
            ...
            <div class="container">
                <div class="sec-maker-header text-center">
                    ...
                    <ul class="nav tab-nav-style-1-a justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#mobiles-best-selling-products">Best
                                Selling</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#mobiles-top-rating-products">Top
                                Rating</a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <div class="col-lg-11 col-md-12">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="smart-phones">
                                                <div class="slider-fouc">
                                                    <div class="specific-category-slider owl-carousel"
                                                        data-item="3">
                                                        <div class="item">
                                                            <div class="image-container">
                                                                ...
                                                                <div class="item-action-behaviors">
                                                                    ...
                                                                    <a class="item-addCart"
                                                                        href="javascript:void(0)">Add to Cart
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="item-content">
                                                        ...
                                                        <div class="item">
                                                            ...
                                                            <div class="item-content">
                                                                <div class="what-product-is">
                                                                    ...
                                                                    <h6 class="item-title">
                                                                        <a href="single-product.html">Apollo Sport
                                                                            Think Smartwatch
                                                                        </a>
                                                                    </h6>
                                                                    <div class="item-stars">
            ...
            <div class="container">
                <div class="sec-maker-header text-center">
                    ...
                    <ul class="nav tab-nav-style-1-a justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#consumer-top-rating-products">Top
                                Rating</a>
                        </li>
                        <li class="nav-item">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-1 col-md-12">
                                        <ul class="nav tab-nav-style-2-a">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#tv"
                                                    title="TV's">
                                                    <i class="ion ion-md-tv"></i>
                                                </a>
                                            </li>
                                                            ...
                                                            <div class="item-content">
                                                                <div class="what-product-is">
                                                                    <ul class="bread-crumb">
                                                                        ...
                                                                        <li>
                                                                            <a
                                                                                href="shop-v2-sub-category.html">Laptops</a>
                                                                        </li>
                                                                    </ul>
                                                                    <h6 class="item-title">
                                                        ...
                                                        <div class="item">
                                                            ...
                                                            <div class="item-content">
                                                                <div class="what-product-is">
                                                                    ...
                                                                    <h6 class="item-title">
                                                                        <a href="single-product.html">Apple Macbook
                                                                            Pro 2017</a>
                                                                    </h6>
                                                                    <div class="item-stars">
                                                                        <div class='star'
                                                        ...
                                                        <div class="item">
                                                            ...
                                                            <div class="item-content">
                                                                <div class="what-product-is">
                                                                    ...
                                                                    <h6 class="item-title">
                                                                        <a href="single-product.html">TCL 4k LED
                                                                            TV</a>
                                                                    </h6>
                                                                    <div class="item-stars">
                                                                        <div class='star'
            ...
            <div class="container">
                <div class="sec-maker-header text-center">
                    ...
                    <ul class="nav tab-nav-style-1-a justify-content-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#books-best-selling-products">Best
                                Selling</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#books-featured-products">Featured
                                Products</a>
                        </li>
                    </ul>
                </div>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="item-content">
                                                <div class="what-product-is">
                                                    ...
                                                    <h6 class="item-title">
                                                        <a href="single-product.html">JavaScript The Definitive Guide
                                                            by David Flanagan
                                                        </a>
                                                    </h6>
                                                    <div class="item-stars">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="item-content">
                                                <div class="what-product-is">
                                                    ...
                                                    <h6 class="item-title">
                                                        <a href="single-product.html">Secret of the JavaScript Ninja
                                                            by Bear Bibeault & John Resig
                                                        </a>
                                                    </h6>
                                                    <div class="item-stars">
                                                        <div class='star' title="0 out of 5 - based on 0 Reviews">
        ...
        <div class="brand-slider u-s-p-b-80">
            <div class="container">
                <div class="brand-slider-content owl-carousel" data-item="5">
                    <div class="brand-pic">
                        <a href="#">
                            <img src={{ asset('frontend/images/brand-logos/b1.png') }} alt="Brand Logo 1">
                        </a>
                    </div>
                    <div class="brand-pic">
                        <a href="#">
                            <img src={{ asset('frontend/images/brand-logos/b1.png') }} alt="Brand Logo 2">
                        </a>
                    </div>
                    <div class="brand-pic">
                        <a href="#">
                            <img src={{ asset('frontend/images/brand-logos/b1.png') }} alt="Brand Logo 3">
                        </a>
                    </div>
                    <div class="brand-pic">
                        <a href="#">
                            <img src={{ asset('frontend/images/brand-logos/b1.png') }} alt="Brand Logo 5">
                        </a>
                    </div>
                    <div class="brand-pic">
                        <a href="#">
                            <img src={{ asset('frontend/images/brand-logos/b1.png') }} alt="Brand Logo 6">
                        </a>
                    </div>
                    <div class="brand-pic">
                        <a href="#">
                            <img src={{ asset('frontend/images/brand-logos/b1.png') }} alt="Brand Logo 7">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="bottom-footer-wrapper">
                    ...
                    <p class="copyright-text">Copyright &copy; 2022
                        <a href="home.html">GoodGoods</a> All Right Reserved
                    </p>
                </div>
            </div>
            <!-- Bottom-Footer /- -->
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 u-s-p-x-0">
                                <div class="newsletter-image">
                                    <a href="shop-v1-root-category.html" class="banner-hover effect-dark-opacity">
                                        <img class="img-fluid"
                                            src={{ asset('frontend/images/banners/newsletter-1.jpg') }}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="zoom-area">
                                    <img id="zoom-pro-quick-view" class="img-fluid"
                                        src={{ asset('frontend/images/product/product@4x.jpg') }}
                                        data-zoom-image={{ asset('frontend/images/product/product@4x.jpg') }}
                                        alt="Zoom Image">
                                    <div id="gallery-quick-view" class="u-s-m-t-10">
                                        <a class="active"
                                            data-image={{ asset('frontend/images/product/product@4x.jpg') }}
                                            data-zoom-image={{ asset('frontend/images/product/product@4x.jpg') }}>
                                            <img src={{ asset('frontend/images/product/product@2x.jpg') }}
                                                alt="Product">
                                        </a>
                                        <a data-image={{ asset('frontend/images/product/product@4x.jpg') }}
                                            data-zoom-image={{ asset('frontend/images/product/product@4x.jpg') }}>
                                            <img src={{ asset('frontend/images/product/product@2x.jpg') }}
                                                alt="Product">
                                        </a>
                                ...
                                <div class="all-information-wrapper">
                                    ...
                                    <div class="section-6-social-media-quantity-actions u-s-p-y-14">
                                        <form action="#" class="post-form">
                                            ...
                                            <div>
                                                <button class="button button-outline-secondary" type="submit">Add
                                                    to cart</button>
                                                <button
