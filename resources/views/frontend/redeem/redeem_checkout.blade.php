        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <form action="{{ route('reedem.checkout.store') }}" method="post">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="row">
                            ...
                            @endphp
                            <input type="hidden" id="product_id" value="{{ $productId }}" name="product_id">
                                ...
                                <div class="group-inline u-s-m-b-13">
                                    <div class="group-1 u-s-p-r-16">
                                        ...
                                        <input type="text" id="email" class="text-field"
                                            value="{{ $user->email }}" readonly name="email" required>
                                    </div>
                                    <div class="group-2">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="order-table">
                                    <table class="u-s-m-b-13">
                                        ...
                                        <tbody>
                                            @foreach ($product_detail as $product)
                                                ...
                                                <tr>
                                                    <td>
                                                        <h6 class="order-h6">{{ $product->title }}</h6>
                                                        <span class="order-span-quantity"> x 1</span>
                                                    </td>
                                                    <td>
                                                        <h6 class="order-h6">{{ $product->point }}</h6>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            @php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h3 class="order-h3">{{ $ArrivalDate1 . ' - ' . $ArrivalDate2 }}
                                                    </h3>
                                                </td>
                                            </tr>
                                            @foreach ($product_detail as $product)
                                                <tr>
                                                    <td>
                                                        <h3 class="order-h3">Total Point</h3>
                                                    </td>
                                                    <td>
                                                        <h3 class="order-h3">
                                                            {{ $product->points }}
                                    ...
                                    <div class="u-s-m-b-13">
                                        <input type="hidden" name="payment_method" id="cod" value="cod">
                                    </div>
